...
var AuthenticationContext = (function () {
    ...
    AuthenticationContext.prototype._renewToken = function (resource, callback) {
        ...
        var urlNavigate = this._getNavigateUrl('token', resource) + '&prompt=none&login_hint=' + encodeURIComponent(this._getLoginHint());
    ...
    AuthenticationContext.prototype._renewIdToken = function (callback) {
        ...
        var urlNavigate = this._getNavigateUrl('id_token', null) + '&prompt=none&login_hint=' + encodeURIComponent(this._getLoginHint());
    ...
    AuthenticationContext.prototype._getLoginHint = function () {
        if (this._user && this._user.profile && this._user.profile.hasOwnProperty('upn')) {
            return this._user.profile.upn;
        }
    ...
    AuthenticationContext.prototype.log = function (level, message, error) {
        if (level <= AuthenticationContext.Logging.level) {
            ...
            AuthenticationContext.Logging.log(formattedMessage);
        }
    };
